    ...
    return (
        <aside className="col-md-3">
            ...
            <div className="list-group">
                ...
                <button href="#" className="list-group-item list-group-item-action active bg-success" data-bs-toggle="collapse" data-bs-target="#accountSubmenu" aria-expanded="false" aria-controls="accountSubmenu">
